package cr0s.javara.render.map.tiled;
...
public class TiledMap {
   ...
   public Image getTileImage(int x, int y, int layerIndex) {
	...
	public void render(int x, int y, int layer) {
		render(x, y, 0, 0, getWidth(), getHeight(), layer, false, 0, 0, 0, 0);
	}
	 ...
	 */
	public void render(int x,int y,int sx,int sy,int width,int height,int l,boolean lineByLine, int vpX, int vpY, int sw, int sh) {
